...
var input1 = [3, 15, 3, 16, 1002, 16, 10, 16, 1, 16, 15, 15, 4, 15, 99, 0, 0];
//console.log("The ans of part 1 is: " + calcIntCode(input1, 4));
var ans1 = calcIntCode(input1, 0)
var ans2 = ans1 + calcIntCode(input1, 1);
var ans3 = ans2 + calcIntCode(input1, 2);
var ans4 = ans3 + calcIntCode(input1, 3);
ans5 = ans4 + calcIntCode(input1, 4);

function getValue(index, intCode, parameter) {
    return parameter === 0 ? intCode[index] : index;
}

function calcIntCode(intCode, phase) {
...
function calcInstruction(instruction) {
